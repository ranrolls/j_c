...
$conf = JFactory::getConfig('configuration');

$db['default']['hostname'] = $conf->get('host');
$db['default']['username'] = $conf->get('user');
$db['default']['password'] = $conf->get('password');
$db['default']['database'] = $conf->get('db');
$db['default']['dbdriver'] = $conf->get('dbtype'); 
$db['default']['dbprefix'] = $conf->get('dbprefix');
