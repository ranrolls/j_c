...
class component extends CI_Controller {
    ...
    function generatePackage($compile=false){
        ...
        JFile::copy(JPATH_ADMINISTRATOR.DS."components".DS."com_".$prj->component .DS.$prj->component.".xml",$tmpComp.DS.$prj->component.".xml" );
        JFile::delete($tmpComp.DS."admin".DS.$prj->component.".xml" );
        ...
        if(!$this->zip->read_dir($tmpDir.'/com_'. $prj->component.DS,FALSE)){
            echo 'sss';
            exit;
        }
    ...
    function manage(){
        ...
        $data['content'] = "<h1>1/3 : Install Script</h1><p>Script to execute when your compnent is installed</p>";
        $data['content'] .= $this->form->get();
        ...
        $data['content'] .= "<h1>2/3: Un-Install Script</h1><p>Script to execute when your compnent is un-installed</p>";
        $data['content'] .= $this->form->get();
        ...
        $data['content'] .= "<h1>3/3: Your Config File</h1><p>File to store global parameters for your component</p>";
        $data['content'] .= $this->form->get();
